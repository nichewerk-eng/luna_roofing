  ...
  return (
    <>
      <SEO
        ...
        description="#1 Wills Point roofing contractor. Expert roof repair, replacement & emergency services. Local, licensed & insured. Free estimates! Call (903) 340-9354"
        ...
        <section className="py-20 bg-gradient-to-r from-primary to-red-700 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl mb-8 max-w-3xl mx-auto">
              Serving Wills Point, TX with expert roofing services since day one. 
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="prose prose-lg mx-auto text-gray-600 mb-12">
                <p className="text-lg leading-relaxed mb-6">
                  As Wills Point's premier roofing contractor, Luna's Roofing LLC has been 
                  protecting homes and businesses in our community for years. We understand 
                  the unique weather challenges that East Texas brings, from severe 
                  thunderstorms to hail damage.
                </p>
                
                <p className="text-lg leading-relaxed">
                  From the historic downtown area to the newer developments, we've 
                  worked on all types of properties throughout Wills Point. Our local 
                  expertise means faster response times and better understanding of 
                  your roofing needs.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">Fully certified Wills Point roofer</p>
                </div>
