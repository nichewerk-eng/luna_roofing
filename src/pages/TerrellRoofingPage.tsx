        ...
        <section className="py-20 bg-gradient-to-r from-primary to-red-700 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl mb-8 max-w-3xl mx-auto">
              Serving Terrell, TX with professional roofing services. 
              Your local roofing experts since day one.
            </p>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="prose prose-lg mx-auto text-gray-600 mb-12">
                <p className="text-lg leading-relaxed mb-6">
                  Luna's Roofing LLC proudly serves Terrell, Texas with comprehensive 
                  roofing services. From the historic downtown district to the growing 
                  residential areas, we've helped protect Terrell homes and businesses 
                  for years.
                </p>
                
                <p className="text-lg leading-relaxed">
                  Our Terrell roofing team understands the unique challenges that 
                  North Texas weather brings, including severe storms, hail, and 
                  high winds. We're here to help 24/7.
                </p>
              </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <p className="text-gray-600 mb-4">
                      Fully licensed roofing contractor with comprehensive insurance 
                      coverage for all Terrell roofing projects.
                    </p>
                  </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h3 className="text-xl font-bold mb-4 text-primary">Residential Roofing</h3>
                ...
                <div>
                  <h3 className="text-xl font-bold mb-4 text-primary">Commercial Roofing</h3>
                  <ul className="space-y-2">
                    <li className="flex items-center">
                      <div className="w-2 h-2 bg-primary rounded-full mr-3"></div>
